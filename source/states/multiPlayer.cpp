...
MultiplayerState::MultiplayerState()
{
    ...
    this->buttons[MULTIPLAYER_BUTTONS_LOCAL] = Button(MultiplayerButtonsX, MultiplayerButtonsY[MULTIPLAYER_BUTTONS_LOCAL], 0.5f, "Single consoles", [](){ });
    this->buttons[MULTIPLAYER_BUTTONS_NETWORK] = Button(MultiplayerButtonsX, MultiplayerButtonsY[MULTIPLAYER_BUTTONS_NETWORK], 0.5f, "Multiple consoles", [](){ });
    this->buttons[MULTIPLAYER_BUTTONS_BACK] = Button(MultiplayerButtonsX, MultiplayerButtonsY[MULTIPLAYER_BUTTONS_BACK], 0.5f, "Back", [](){ });
