...
# Your values.
APP_TITLE           :=	Yahtzee3DS
APP_DESCRIPTION     :=	Play Yahtzee on your 3DS with up to 6 players!
...
BANNER_IMAGE        :=	sprites/banner.png
...
CFLAGS	+=	$(INCLUDE) -DARM11 -D_3DS -D_GNU_SOURCE -DVERSION="\"$(VERSION)\""
